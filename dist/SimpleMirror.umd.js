(function (global, factory) {
  ...
  (global = global || self, global.SimpleMirror = factory());
  ...
  function joinPoint(doc, pos, dir) {
    ...
    for (var d = $pos.depth;; d--) {
      ...
      if (before && !before.isTextblock && joinable$1(before, after) && $pos.node(d).canReplace(index, index + 1)) {
        return pos;
      }
  ...
  prototypeAccessors$1$6.inline.get = function () {
    return this.type instanceof InlineType;
  };

  Object.defineProperties(Decoration.prototype, prototypeAccessors$1$6); // DecorationAttrs:: interface
  ...
  var injectFileToView = function injectFileToView(view, url) {
  ...
  var createPragraph = function createPragraph(state, dispatch, view) {
  ...
  var handleEnter = function handleEnter(state, dispatch, view) {
    ...
    if (grandParent.type !== schema$1.nodes.list_item) {
      // not in a list
      if (grandParent.type !== schema$1.nodes.table_cell) {
        command = chainCommands(newlineInCode, createParagraphNear, liftEmptyBlock, splitBlock);
      } else {
    ...
    if (dispatch) {
      if (!navigator.onLine || !options || !options.cloudinary) {
        ...
        if (window.cloudinary) {
          ...
          loadScript('https://widget.cloudinary.com/v2.0/global/all.js').then(function () {
...
//# sourceMappingURL=SimpleMirror.umd.js.map
